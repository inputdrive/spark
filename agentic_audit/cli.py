...
from .catalog import detect_os_name
...
def main() -> None:
    ...
    resolved_os_name = args.os_name or detect_os_name()
    payload = discover_artifacts(home_dir=args.home_dir, os_name=resolved_os_name)
